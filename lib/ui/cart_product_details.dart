...
import 'package:plank/model/payment.dart';
...
// Enables us to start the payment service
  startPayment() async {
    ...
    options.putIfAbsent("description", () => "RazorPay Transaction");
    options.putIfAbsent("amount", () => "${widget.cartProductPrice * 100}");
    options.putIfAbsent("email", () => "akash.mhatre@spit.ac.in");
    options.putIfAbsent("contact", () => "8446302890");
